...
$this->registerCssFile("@web/styles/contact_styles.css", [
    'depends' => [BootstrapAsset::class],
], 'css-contact');


$this->registerCssFile("@web/styles/contact_responsive.css", [
    'depends' => [BootstrapAsset::class],
                ...
                <div class="contact_info_container d-flex flex-lg-row flex-column justify-content-between align-items-between">
                    ...
                    <div class="contact_info_item d-flex flex-row align-items-center justify-content-start">
                        ...
                        <div class="contact_info_content">
                            ...
                            <div class="contact_info_text">+38 067 410 35 10</div>
                        </div>
                    </div>
                    ...
                    <div class="contact_info_item d-flex flex-row align-items-center justify-content-start">
                        ...
                        <div class="contact_info_content">
                            ...
                            <div class="contact_info_text">zt1552@gmail.com</div>
                        </div>
                    </div>
                    ...
                    <div class="contact_info_item d-flex flex-row align-items-center justify-content-start">
                        ...
                        <div class="contact_info_content">
                            ...
                            <div class="contact_info_text">г. Житомир, ул. Трипольская, 13а, офис 105</div>
                        </div>
                    </div>
