(function ($) {
    ...
    /*--------------------------------
        Brand logo active
    -----------------------------------*/
    $('.brand-logo-active , .brand-logo-active-2').click({
        slidesToShow: 6,
        slidesToScroll: 1,
        loop: true,
        dots: false,
    ...
    /*--------------------------------
        Testimonial active
    -----------------------------------*/
    $('.testimonial-active , .testimonial-active-2').click({
        slidesToShow: 1,
        slidesToScroll: 1,
        loop: true,
        dots: false,
    ...
    -----------------------------------*/
    $('.testimonial-img-slider-active').click({
        slidesToShow: 1,
        slidesToScroll: 1,
        arrows: false,
        draggable: false,
    ...
    $('.testimonial-img-slider-active-3').on('init afterChange',function(){
        ...
        const activeSlide = document.querySelector('.testimonial-img-slider.click-current');
        titleImg.src = activeSlide.nextSibling.querySelector('img').src;
    });
    $('.testimonial-img-slider-active-3').click({
        slidesToShow: 1,
        slidesToScroll: 1,
        arrows: false,
        draggable: false,
    ...
    --------------------------------------*/
    $('.testimonial-img-slider-active-2').click({
        slidesToShow: 5,
        slidesToScroll: 1,
        arrows: false,
        dots: false,
    ...
    -----------------------------------*/
    $('.product-img-slider-active').click({
        slidesToShow: 1,
        slidesToScroll: 1,
        dots: true,
        fade: false,
    ...
    -----------------------------------*/
    $('.product-details-3-img-slider').click({
        slidesToShow: 1,
        slidesToScroll: 1,
        dots: true,
        loop: true,
    ...
    -----------------------------------*/
    $('.product-details-3-img-slider-2').click({
        slidesToShow: 1,
        slidesToScroll: 1,
        dots: true,
        loop: true,
    ...
    -----------------------------------*/
    $('.pro-dec-big-img-slider-2').click({
        slidesToShow: 1,
        slidesToScroll: 1,
        arrows: false,
        draggable: false,
    ...
    /*--
        Product details 2 click carousel as Nav
    --------------------------------------------*/
    $('.product-dec-slider-2').click({
        slidesToShow: 7,
        slidesToScroll: 1,
        vertical: true,
    ...
    -----------------------------------*/
    $('.product-details-slider-5-active').click({
        slidesToShow: 1,
        slidesToScroll: 1,
        dots: false,
        loop: true,
    ...
    -----------------------------------*/
    $('.product-details-tab-small').click({
        slidesToShow: 5,
        slidesToScroll: 1,
        dots: false,
        loop: true,
